...
import mpi.eudico.client.annotator.commands.AudioSpectrogramCA;
...
public class SignalViewer extends TimeScaleBasedViewer
    ...
    private JMenuItem spectroForSelMI;
    private AudioSpectrogramCA spectrogramCA;
...
//        }
    ...
    public void setMediaSampler(WAVSamplesProvider sampler, MediaDescriptor mediaDescriptor) {
    	...
    	if (spectrogramCA != null) {
    		spectrogramCA.setSamplesProvider(samp);
    		spectrogramCA.setOffset(mediaOffset);
    	}
    }
    
    private void showSpectrogramWindow() {
    	// if selection > 10 sec, or if there is no selection, show message
    	// calculate margin to left and right, 10%?
...
//        }
    ...
    */
    ...
    private void createPopupMenu() {
        ...
        spectroForSelMI = new JMenuItem();
		popup.add(spectroForSelMI);
...
//        }
    ...
    private void updatePopupMenu() {
    	if (popup != null) {
    		...
    		spectroForSelMI.setEnabled(enable);
    		...
    		if (spectrogramCA == null) {
    			spectrogramCA = (AudioSpectrogramCA) ELANCommandFactory.getCommandAction(
    					getViewerManager().getTranscription(), ELANCommandFactory.AUDIO_SPECTROGRAM);
    			spectrogramCA.setSamplesProvider(samp);
    			spectrogramCA.setOffset(mediaOffset);
    			spectroForSelMI.setAction(spectrogramCA);
    		}
    	}
    }
